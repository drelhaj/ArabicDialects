 ...
 */
 public class MyFilteredClassifier2 {
	 ...
	 */
	public void makeInstance(String first, String second) {
	...
	public void classify() {
		try {
			...
			System.out.println("Class predicted: " + instances.classAttribute().value((int) pred) + " value = "+pred);
		}
		catch (Exception e) {
	...
	public static void main (String[] args) {
		...
		File dir = new File("model");
		  ...
		  String firstInstance = name.substring(23,26);
		  String secondInstance = name.substring(27,30);
		  
System.out.println(firstInstance + "\t" + secondInstance + "\t" + name);

		MyFilteredClassifier2 classifier;

		classifier = new MyFilteredClassifier2();
			classifier.load("test/"+testFile+" ("+i+").txt");
			classifier.loadModel("model/"+name);
			classifier.makeInstance(firstInstance, secondInstance);
			classifier.classify();
