 ...
 */
public class MyFilteredLearner2 {
	...
	public static void main (String[] args) throws Exception {
		...
		MyFilteredLearner2 learner;
			learner = new MyFilteredLearner2();
			learner.loadDataset("arff/AllClassesFeaturesTrunc20.arff");
			// Evaluation must be done before training
			learner.evaluate();
			learner.learn();
			learner.saveModel("model/AllClassesFeaturesTrunc20"+classifierName+"_Reduced_All.dat");
