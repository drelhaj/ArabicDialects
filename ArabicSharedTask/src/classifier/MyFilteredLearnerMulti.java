 ...
 */
public class MyFilteredLearnerMulti {
	...
	public static void main (String[] args) throws Exception {
		...
		MyFilteredLearnerMulti learner;
			learner = new MyFilteredLearnerMulti();
			learner.loadDataset("arff/FiveClassespos.arff");
			// Evaluation must be done before training
			learner.evaluate();
			learner.learn();
			learner.saveModel("model/FiveClassespos"+classifierName+".dat");
